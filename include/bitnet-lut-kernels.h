...
#define BM1024_1024 128
#define BBK1024_1024 96
template<int batch_size, int K3>
inline void three_tbl_impl_1024_1024(int32_t* c, int8_t* lut, uint8_t* a, uint8_t* sign) {
#ifdef __AVX2__
    ...
    const int KK = BBK1024_1024 / 3;
#pragma unroll
        for (int i = 0; i < BM1024_1024; i += 32) {
        __m256i vec_as[KK / 2];
...
#pragma unroll
        ...
        __m256i vec_gc0 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i      + BM1024_1024 * bs));
        __m256i vec_gc1 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i + 8  + BM1024_1024 * bs));
        __m256i vec_gc2 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i + 16 + BM1024_1024 * bs));
        __m256i vec_gc3 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i + 24 + BM1024_1024 * bs));
        ...
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i      + BM1024_1024 * bs), vec_gc0);
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i + 8  + BM1024_1024 * bs), vec_gc1);
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i + 16 + BM1024_1024 * bs), vec_gc2);
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i + 24 + BM1024_1024 * bs), vec_gc3);
    }
    }
#endif
}
...
inline int32_t two_tbl_impl1024_1024(int32_t* c, int8_t* lut, uint8_t* a) {
#ifdef __AVX2__
    const __m256i vec_mask = _mm256_set1_epi8(0x0f);
    const int KK = BK2 / 2;
#pragma unroll
...
int32_t three_qgemm_lut_1024_1024(void* A, void* sign, void* LUT, void* Scales, void* LUT_Scales, void* C) {
    alignas(32) uint32_t CBits[BATCH_SIZE * BM1024_1024];
    memset(&(CBits[0]), 0, BATCH_SIZE * BM1024_1024 * sizeof(int32_t));
#pragma unroll
    for (int32_t k_outer = 0; k_outer < 960 / BBK1024_1024; ++k_outer) {
        three_tbl_impl_1024_1024<BATCH_SIZE, 960>((&(((int32_t*)CBits)[0])), (&(((int8_t*)LUT)[(k_outer * BBK1024_1024 / 3 * 32)])), (&(((uint8_t*)A)[(k_outer * BBK1024_1024 / 3 / 2 * BM1024_1024)])), (&(((uint8_t*)sign)[(k_outer * BBK1024_1024 / 3 / 8 * BM1024_1024)])));
    }
#pragma unroll
    for (int bs = 0; bs < BATCH_SIZE; bs++) {
#pragma unroll
        for (int i = 0; i < BM1024_1024; i++) {
            ((int32_t*)C)[i] = (int32_t)(((int32_t*)CBits)[i + bs * BM1024_1024]);
        }
  }
  return 0;
}
...
template<int BATCH_SIZE>
int32_t two_qgemm_lut_1024_1024(void* A, void* LUT, void* Scales, void* LUT_Scales, void* C) {
    alignas(32) uint32_t CBits[BATCH_SIZE * BM1024_1024];
    memset(&(CBits[0]), 0, BATCH_SIZE * BM1024_1024 * sizeof(int32_t));
#pragma unroll
    for (int32_t k_outer = 0; k_outer < 64 / 32; ++k_outer) {
        two_tbl_impl1024_1024<BATCH_SIZE, 64>((&(((int32_t*)CBits)[0])), (&(((int8_t*)LUT)[(k_outer * BK2 / 2 * 32)])), (&(((uint8_t*)A)[(k_outer * BK2 / 2 / 2 * BM1024_1024)])));
    }
#pragma unroll
    for (int bs = 0; bs < BATCH_SIZE; bs++) {
#pragma unroll
...
#define BM4096_1024 128
#define BBK4096_1024 96
template<int batch_size, int K3>
inline void three_tbl_impl_4096_1024(int32_t* c, int8_t* lut, uint8_t* a, uint8_t* sign) {
#ifdef __AVX2__
    const __m256i vec_mask = _mm256_set1_epi8(0x0f);
    const __m256i vec_sign_mask  = _mm256_set1_epi16(0x8000);
    const __m256i vec_zero  = _mm256_set1_epi8(0x00);
    const __m256i vec_one  = _mm256_set1_epi8(0xff);
    const int KK = BBK4096_1024 / 3;
#pragma unroll
        for (int i = 0; i < BM4096_1024; i += 32) {
        __m256i vec_as[KK / 2];
        __m256i vec_signs[KK / 8];
        #pragma unroll
        for (int ai = 0; ai < KK / 2; ai++) {
...
#pragma unroll
        ...
        __m256i vec_gc0 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i      + BM4096_1024 * bs));
        __m256i vec_gc1 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i + 8  + BM4096_1024 * bs));
        __m256i vec_gc2 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i + 16 + BM4096_1024 * bs));
        __m256i vec_gc3 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i + 24 + BM4096_1024 * bs));
        vec_gc0 = _mm256_add_epi32(vec_gc0, _mm256_cvtepi16_epi32(_mm256_castsi256_si128(vec_c0)));
        vec_gc1 = _mm256_add_epi32(vec_gc1, _mm256_cvtepi16_epi32(_mm256_extracti128_si256(vec_c0, 1)));
        vec_gc2 = _mm256_add_epi32(vec_gc2, _mm256_cvtepi16_epi32(_mm256_castsi256_si128(vec_c1)));
        vec_gc3 = _mm256_add_epi32(vec_gc3, _mm256_cvtepi16_epi32(_mm256_extracti128_si256(vec_c1, 1)));
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i      + BM4096_1024 * bs), vec_gc0);
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i + 8  + BM4096_1024 * bs), vec_gc1);
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i + 16 + BM4096_1024 * bs), vec_gc2);
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i + 24 + BM4096_1024 * bs), vec_gc3);
    }
    }
#endif
}
...
template<int batch_size, int K2>
inline int32_t two_tbl_impl4096_1024(int32_t* c, int8_t* lut, uint8_t* a) {
#ifdef __AVX2__
    const __m256i vec_mask = _mm256_set1_epi8(0x0f);
    const int KK = BK2 / 2;
#pragma unroll
...
template<int BATCH_SIZE>
int32_t three_qgemm_lut_4096_1024(void* A, void* sign, void* LUT, void* Scales, void* LUT_Scales, void* C) {
    alignas(32) uint32_t CBits[BATCH_SIZE * BM4096_1024];
    memset(&(CBits[0]), 0, BATCH_SIZE * BM4096_1024 * sizeof(int32_t));
#pragma unroll
    for (int32_t k_outer = 0; k_outer < 960 / BBK4096_1024; ++k_outer) {
        three_tbl_impl_4096_1024<BATCH_SIZE, 960>((&(((int32_t*)CBits)[0])), (&(((int8_t*)LUT)[(k_outer * BBK4096_1024 / 3 * 32)])), (&(((uint8_t*)A)[(k_outer * BBK4096_1024 / 3 / 2 * BM4096_1024)])), (&(((uint8_t*)sign)[(k_outer * BBK4096_1024 / 3 / 8 * BM4096_1024)])));
    }
#pragma unroll
    for (int bs = 0; bs < BATCH_SIZE; bs++) {
#pragma unroll
        for (int i = 0; i < BM4096_1024; i++) {
            ((int32_t*)C)[i] = (int32_t)(((int32_t*)CBits)[i + bs * BM4096_1024]);
        }
  }
  return 0;
}
...
template<int BATCH_SIZE>
int32_t two_qgemm_lut_4096_1024(void* A, void* LUT, void* Scales, void* LUT_Scales, void* C) {
    alignas(32) uint32_t CBits[BATCH_SIZE * BM4096_1024];
    memset(&(CBits[0]), 0, BATCH_SIZE * BM4096_1024 * sizeof(int32_t));
#pragma unroll
    for (int32_t k_outer = 0; k_outer < 64 / 32; ++k_outer) {
        two_tbl_impl4096_1024<BATCH_SIZE, 64>((&(((int32_t*)CBits)[0])), (&(((int8_t*)LUT)[(k_outer * BK2 / 2 * 32)])), (&(((uint8_t*)A)[(k_outer * BK2 / 2 / 2 * BM4096_1024)])));
    }
#pragma unroll
    for (int bs = 0; bs < BATCH_SIZE; bs++) {
#pragma unroll
...
#define BM768_768 128
#define BBK768_768 96
template<int batch_size, int K3>
inline void three_tbl_impl_768_768(int32_t* c, int8_t* lut, uint8_t* a, uint8_t* sign) {
#ifdef __AVX2__
    const __m256i vec_mask = _mm256_set1_epi8(0x0f);
    const __m256i vec_sign_mask  = _mm256_set1_epi16(0x8000);
    const __m256i vec_zero  = _mm256_set1_epi8(0x00);
    const __m256i vec_one  = _mm256_set1_epi8(0xff);
    const int KK = BBK768_768 / 3;
#pragma unroll
        for (int i = 0; i < BM768_768; i += 32) {
        __m256i vec_as[KK / 2];
        __m256i vec_signs[KK / 8];
        #pragma unroll
        for (int ai = 0; ai < KK / 2; ai++) {
...
#pragma unroll
        ...
        __m256i vec_gc0 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i      + BM768_768 * bs));
        __m256i vec_gc1 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i + 8  + BM768_768 * bs));
        __m256i vec_gc2 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i + 16 + BM768_768 * bs));
        __m256i vec_gc3 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i + 24 + BM768_768 * bs));
        vec_gc0 = _mm256_add_epi32(vec_gc0, _mm256_cvtepi16_epi32(_mm256_castsi256_si128(vec_c0)));
        vec_gc1 = _mm256_add_epi32(vec_gc1, _mm256_cvtepi16_epi32(_mm256_extracti128_si256(vec_c0, 1)));
        vec_gc2 = _mm256_add_epi32(vec_gc2, _mm256_cvtepi16_epi32(_mm256_castsi256_si128(vec_c1)));
        vec_gc3 = _mm256_add_epi32(vec_gc3, _mm256_cvtepi16_epi32(_mm256_extracti128_si256(vec_c1, 1)));
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i      + BM768_768 * bs), vec_gc0);
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i + 8  + BM768_768 * bs), vec_gc1);
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i + 16 + BM768_768 * bs), vec_gc2);
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i + 24 + BM768_768 * bs), vec_gc3);
    }
    }
#endif
}
...
template<int batch_size, int K2>
inline int32_t two_tbl_impl768_768(int32_t* c, int8_t* lut, uint8_t* a) {
#ifdef __AVX2__
    const __m256i vec_mask = _mm256_set1_epi8(0x0f);
    const int KK = BK2 / 2;
#pragma unroll
...
template<int BATCH_SIZE>
int32_t three_qgemm_lut_768_768(void* A, void* sign, void* LUT, void* Scales, void* LUT_Scales, void* C) {
    alignas(32) uint32_t CBits[BATCH_SIZE * BM768_768];
    memset(&(CBits[0]), 0, BATCH_SIZE * BM768_768 * sizeof(int32_t));
#pragma unroll
    for (int32_t k_outer = 0; k_outer < 768 / BBK768_768; ++k_outer) {
        three_tbl_impl_768_768<BATCH_SIZE, 768>((&(((int32_t*)CBits)[0])), (&(((int8_t*)LUT)[(k_outer * BBK768_768 / 3 * 32)])), (&(((uint8_t*)A)[(k_outer * BBK768_768 / 3 / 2 * BM768_768)])), (&(((uint8_t*)sign)[(k_outer * BBK768_768 / 3 / 8 * BM768_768)])));
    }
#pragma unroll
    for (int bs = 0; bs < BATCH_SIZE; bs++) {
#pragma unroll
        for (int i = 0; i < BM768_768; i++) {
            ((int32_t*)C)[i] = (int32_t)(((int32_t*)CBits)[i + bs * BM768_768]);
        }
  }
  return 0;
}
...
template<int BATCH_SIZE>
int32_t two_qgemm_lut_768_768(void* A, void* LUT, void* Scales, void* LUT_Scales, void* C) {
    alignas(32) uint32_t CBits[BATCH_SIZE * BM768_768];
    memset(&(CBits[0]), 0, BATCH_SIZE * BM768_768 * sizeof(int32_t));
#pragma unroll
    for (int32_t k_outer = 0; k_outer < 0 / 32; ++k_outer) {
        two_tbl_impl768_768<BATCH_SIZE, 0>((&(((int32_t*)CBits)[0])), (&(((int8_t*)LUT)[(k_outer * BK2 / 2 * 32)])), (&(((uint8_t*)A)[(k_outer * BK2 / 2 / 2 * BM768_768)])));
    }
#pragma unroll
    for (int bs = 0; bs < BATCH_SIZE; bs++) {
#pragma unroll
...
#define BM3072_768 128
#define BBK3072_768 96
template<int batch_size, int K3>
inline void three_tbl_impl_3072_768(int32_t* c, int8_t* lut, uint8_t* a, uint8_t* sign) {
#ifdef __AVX2__
    const __m256i vec_mask = _mm256_set1_epi8(0x0f);
    const __m256i vec_sign_mask  = _mm256_set1_epi16(0x8000);
    const __m256i vec_zero  = _mm256_set1_epi8(0x00);
    const __m256i vec_one  = _mm256_set1_epi8(0xff);
    const int KK = BBK3072_768 / 3;
#pragma unroll
        for (int i = 0; i < BM3072_768; i += 32) {
        __m256i vec_as[KK / 2];
        __m256i vec_signs[KK / 8];
        #pragma unroll
        for (int ai = 0; ai < KK / 2; ai++) {
...
#pragma unroll
        ...
        __m256i vec_gc0 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i      + BM3072_768 * bs));
        __m256i vec_gc1 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i + 8  + BM3072_768 * bs));
        __m256i vec_gc2 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i + 16 + BM3072_768 * bs));
        __m256i vec_gc3 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i + 24 + BM3072_768 * bs));
        vec_gc0 = _mm256_add_epi32(vec_gc0, _mm256_cvtepi16_epi32(_mm256_castsi256_si128(vec_c0)));
        vec_gc1 = _mm256_add_epi32(vec_gc1, _mm256_cvtepi16_epi32(_mm256_extracti128_si256(vec_c0, 1)));
        vec_gc2 = _mm256_add_epi32(vec_gc2, _mm256_cvtepi16_epi32(_mm256_castsi256_si128(vec_c1)));
        vec_gc3 = _mm256_add_epi32(vec_gc3, _mm256_cvtepi16_epi32(_mm256_extracti128_si256(vec_c1, 1)));
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i      + BM3072_768 * bs), vec_gc0);
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i + 8  + BM3072_768 * bs), vec_gc1);
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i + 16 + BM3072_768 * bs), vec_gc2);
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i + 24 + BM3072_768 * bs), vec_gc3);
    }
    }
#endif
}
...
template<int batch_size, int K2>
inline int32_t two_tbl_impl3072_768(int32_t* c, int8_t* lut, uint8_t* a) {
#ifdef __AVX2__
    const __m256i vec_mask = _mm256_set1_epi8(0x0f);
    const int KK = BK2 / 2;
#pragma unroll
...
template<int BATCH_SIZE>
int32_t three_qgemm_lut_3072_768(void* A, void* sign, void* LUT, void* Scales, void* LUT_Scales, void* C) {
    alignas(32) uint32_t CBits[BATCH_SIZE * BM3072_768];
    memset(&(CBits[0]), 0, BATCH_SIZE * BM3072_768 * sizeof(int32_t));
#pragma unroll
    for (int32_t k_outer = 0; k_outer < 768 / BBK3072_768; ++k_outer) {
        three_tbl_impl_3072_768<BATCH_SIZE, 768>((&(((int32_t*)CBits)[0])), (&(((int8_t*)LUT)[(k_outer * BBK3072_768 / 3 * 32)])), (&(((uint8_t*)A)[(k_outer * BBK3072_768 / 3 / 2 * BM3072_768)])), (&(((uint8_t*)sign)[(k_outer * BBK3072_768 / 3 / 8 * BM3072_768)])));
    }
#pragma unroll
    for (int bs = 0; bs < BATCH_SIZE; bs++) {
#pragma unroll
        for (int i = 0; i < BM3072_768; i++) {
            ((int32_t*)C)[i] = (int32_t)(((int32_t*)CBits)[i + bs * BM3072_768]);
        }
  }
  return 0;
}
...
template<int BATCH_SIZE>
int32_t two_qgemm_lut_3072_768(void* A, void* LUT, void* Scales, void* LUT_Scales, void* C) {
    alignas(32) uint32_t CBits[BATCH_SIZE * BM3072_768];
    memset(&(CBits[0]), 0, BATCH_SIZE * BM3072_768 * sizeof(int32_t));
#pragma unroll
    for (int32_t k_outer = 0; k_outer < 0 / 32; ++k_outer) {
        two_tbl_impl3072_768<BATCH_SIZE, 0>((&(((int32_t*)CBits)[0])), (&(((int8_t*)LUT)[(k_outer * BK2 / 2 * 32)])), (&(((uint8_t*)A)[(k_outer * BK2 / 2 / 2 * BM3072_768)])));
    }
#pragma unroll
    for (int bs = 0; bs < BATCH_SIZE; bs++) {
#pragma unroll
...
#define BM768_3072 128
#define BBK768_3072 96
template<int batch_size, int K3>
inline void three_tbl_impl_768_3072(int32_t* c, int8_t* lut, uint8_t* a, uint8_t* sign) {
#ifdef __AVX2__
    const __m256i vec_mask = _mm256_set1_epi8(0x0f);
    const __m256i vec_sign_mask  = _mm256_set1_epi16(0x8000);
    const __m256i vec_zero  = _mm256_set1_epi8(0x00);
    const __m256i vec_one  = _mm256_set1_epi8(0xff);
    const int KK = BBK768_3072 / 3;
#pragma unroll
        for (int i = 0; i < BM768_3072; i += 32) {
        __m256i vec_as[KK / 2];
        __m256i vec_signs[KK / 8];
        #pragma unroll
        for (int ai = 0; ai < KK / 2; ai++) {
...
#pragma unroll
        ...
        __m256i vec_gc0 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i      + BM768_3072 * bs));
        __m256i vec_gc1 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i + 8  + BM768_3072 * bs));
        __m256i vec_gc2 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i + 16 + BM768_3072 * bs));
        __m256i vec_gc3 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i + 24 + BM768_3072 * bs));
        vec_gc0 = _mm256_add_epi32(vec_gc0, _mm256_cvtepi16_epi32(_mm256_castsi256_si128(vec_c0)));
        vec_gc1 = _mm256_add_epi32(vec_gc1, _mm256_cvtepi16_epi32(_mm256_extracti128_si256(vec_c0, 1)));
        vec_gc2 = _mm256_add_epi32(vec_gc2, _mm256_cvtepi16_epi32(_mm256_castsi256_si128(vec_c1)));
        vec_gc3 = _mm256_add_epi32(vec_gc3, _mm256_cvtepi16_epi32(_mm256_extracti128_si256(vec_c1, 1)));
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i      + BM768_3072 * bs), vec_gc0);
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i + 8  + BM768_3072 * bs), vec_gc1);
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i + 16 + BM768_3072 * bs), vec_gc2);
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i + 24 + BM768_3072 * bs), vec_gc3);
    }
    }
#endif
}
...
template<int batch_size, int K2>
inline int32_t two_tbl_impl768_3072(int32_t* c, int8_t* lut, uint8_t* a) {
#ifdef __AVX2__
    const __m256i vec_mask = _mm256_set1_epi8(0x0f);
    const int KK = BK2 / 2;
#pragma unroll
...
template<int BATCH_SIZE>
int32_t three_qgemm_lut_768_3072(void* A, void* sign, void* LUT, void* Scales, void* LUT_Scales, void* C) {
    alignas(32) uint32_t CBits[BATCH_SIZE * BM768_3072];
    memset(&(CBits[0]), 0, BATCH_SIZE * BM768_3072 * sizeof(int32_t));
#pragma unroll
    for (int32_t k_outer = 0; k_outer < 3072 / BBK768_3072; ++k_outer) {
        three_tbl_impl_768_3072<BATCH_SIZE, 3072>((&(((int32_t*)CBits)[0])), (&(((int8_t*)LUT)[(k_outer * BBK768_3072 / 3 * 32)])), (&(((uint8_t*)A)[(k_outer * BBK768_3072 / 3 / 2 * BM768_3072)])), (&(((uint8_t*)sign)[(k_outer * BBK768_3072 / 3 / 8 * BM768_3072)])));
    }
#pragma unroll
    for (int bs = 0; bs < BATCH_SIZE; bs++) {
#pragma unroll
        for (int i = 0; i < BM768_3072; i++) {
            ((int32_t*)C)[i] = (int32_t)(((int32_t*)CBits)[i + bs * BM768_3072]);
        }
  }
  return 0;
}
...
template<int BATCH_SIZE>
int32_t two_qgemm_lut_768_3072(void* A, void* LUT, void* Scales, void* LUT_Scales, void* C) {
    alignas(32) uint32_t CBits[BATCH_SIZE * BM768_3072];
    memset(&(CBits[0]), 0, BATCH_SIZE * BM768_3072 * sizeof(int32_t));
#pragma unroll
    for (int32_t k_outer = 0; k_outer < 0 / 32; ++k_outer) {
        two_tbl_impl768_3072<BATCH_SIZE, 0>((&(((int32_t*)CBits)[0])), (&(((int8_t*)LUT)[(k_outer * BK2 / 2 * 32)])), (&(((uint8_t*)A)[(k_outer * BK2 / 2 / 2 * BM768_3072)])));
    }
#pragma unroll
    for (int bs = 0; bs < BATCH_SIZE; bs++) {
#pragma unroll
...
void ggml_preprocessor(int bs, int m, int three_k, int two_k, void* B, void* LUT_Scales, void* Three_QLUT, void* Two_QLUT) {
    ...
    if (m == 1024 && two_k == 64 && three_k == 960) {
        for (int32_t b = 0; b < bs; b++) {
            per_tensor_quant(two_k + three_k, (&(((float*)LUT_Scales)[b])), (&(((float*)B)[b * (two_k + three_k)])));
            three_lut_ctor<960>((&(((int8_t*)Three_QLUT)[b * three_k / 3 * 32])), (&(((float*)B)[b * (three_k + two_k)])), (&(((float*)LUT_Scales)[b])));
            two_lut_ctor<64>((&(((int8_t*)Two_QLUT)[b * two_k / 2 * 32])), (&(((float*)B)[b * (three_k + two_k) + 960])), (&(((float*)LUT_Scales)[b])));
        }
    }
    else if (m == 4096 && two_k == 64 && three_k == 960) {
        for (int32_t b = 0; b < bs; b++) {
            per_tensor_quant(two_k + three_k, (&(((float*)LUT_Scales)[b])), (&(((float*)B)[b * (two_k + three_k)])));
            three_lut_ctor<960>((&(((int8_t*)Three_QLUT)[b * three_k / 3 * 32])), (&(((float*)B)[b * (three_k + two_k)])), (&(((float*)LUT_Scales)[b])));
            two_lut_ctor<64>((&(((int8_t*)Two_QLUT)[b * two_k / 2 * 32])), (&(((float*)B)[b * (three_k + two_k) + 960])), (&(((float*)LUT_Scales)[b])));
    ...
    else if (m == 768 && two_k == 0 && three_k == 768) {
        for (int32_t b = 0; b < bs; b++) {
            per_tensor_quant(two_k + three_k, (&(((float*)LUT_Scales)[b])), (&(((float*)B)[b * (two_k + three_k)])));
            three_lut_ctor<768>((&(((int8_t*)Three_QLUT)[b * three_k / 3 * 32])), (&(((float*)B)[b * (three_k + two_k)])), (&(((float*)LUT_Scales)[b])));
            two_lut_ctor<0>((&(((int8_t*)Two_QLUT)[b * two_k / 2 * 32])), (&(((float*)B)[b * (three_k + two_k) + 768])), (&(((float*)LUT_Scales)[b])));
        }
    }
    else if (m == 3072 && two_k == 0 && three_k == 768) {
        for (int32_t b = 0; b < bs; b++) {
            per_tensor_quant(two_k + three_k, (&(((float*)LUT_Scales)[b])), (&(((float*)B)[b * (two_k + three_k)])));
            three_lut_ctor<768>((&(((int8_t*)Three_QLUT)[b * three_k / 3 * 32])), (&(((float*)B)[b * (three_k + two_k)])), (&(((float*)LUT_Scales)[b])));
            two_lut_ctor<0>((&(((int8_t*)Two_QLUT)[b * two_k / 2 * 32])), (&(((float*)B)[b * (three_k + two_k) + 768])), (&(((float*)LUT_Scales)[b])));
    ...
    else if (m == 768 && two_k == 0 && three_k == 3072) {
        for (int32_t b = 0; b < bs; b++) {
            per_tensor_quant(two_k + three_k, (&(((float*)LUT_Scales)[b])), (&(((float*)B)[b * (two_k + three_k)])));
...
void ggml_qgemm_lut(int bs, int m, int k, int BK, void* A, void* sign, void* LUT, void* Scales, void* LUT_Scales, void* C) {
    if (m == 1024 && k == 1024) {
        if (BK == 64) {
            if (bs == 1) {
                two_qgemm_lut_1024_1024<1>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 8) {
                two_qgemm_lut_1024_1024<8>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 32) {
                two_qgemm_lut_1024_1024<32>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 128) {
                two_qgemm_lut_1024_1024<128>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 256) {
                two_qgemm_lut_1024_1024<256>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 512) {
                two_qgemm_lut_1024_1024<512>(A, LUT, Scales, LUT_Scales, C);
            }
        }
        else if (BK == 960) {
            if (bs == 1) {
                three_qgemm_lut_1024_1024<1>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 8) {
                three_qgemm_lut_1024_1024<8>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 32) {
                three_qgemm_lut_1024_1024<32>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 128) {
                three_qgemm_lut_1024_1024<128>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 256) {
                three_qgemm_lut_1024_1024<256>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 512) {
                three_qgemm_lut_1024_1024<512>(A, sign, LUT, Scales, LUT_Scales, C);
            }
        }
    }
    else if (m == 4096 && k == 1024) {
        if (BK == 64) {
            if (bs == 1) {
                two_qgemm_lut_4096_1024<1>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 8) {
                two_qgemm_lut_4096_1024<8>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 32) {
                two_qgemm_lut_4096_1024<32>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 128) {
                two_qgemm_lut_4096_1024<128>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 256) {
                two_qgemm_lut_4096_1024<256>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 512) {
                two_qgemm_lut_4096_1024<512>(A, LUT, Scales, LUT_Scales, C);
            }
        }
        else if (BK == 960) {
            if (bs == 1) {
                three_qgemm_lut_4096_1024<1>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 8) {
                three_qgemm_lut_4096_1024<8>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 32) {
                three_qgemm_lut_4096_1024<32>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 128) {
                three_qgemm_lut_4096_1024<128>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 256) {
                three_qgemm_lut_4096_1024<256>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 512) {
                three_qgemm_lut_4096_1024<512>(A, sign, LUT, Scales, LUT_Scales, C);
            }
        }
    }
        ...
        if (BK == 0) {
            if (bs == 1) {
                two_qgemm_lut_768_768<1>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 8) {
                two_qgemm_lut_768_768<8>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 32) {
                two_qgemm_lut_768_768<32>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 128) {
                two_qgemm_lut_768_768<128>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 256) {
                two_qgemm_lut_768_768<256>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 512) {
                two_qgemm_lut_768_768<512>(A, LUT, Scales, LUT_Scales, C);
            }
        }
        else if (BK == 768) {
            if (bs == 1) {
                three_qgemm_lut_768_768<1>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 8) {
                three_qgemm_lut_768_768<8>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 32) {
                three_qgemm_lut_768_768<32>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 128) {
                three_qgemm_lut_768_768<128>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 256) {
                three_qgemm_lut_768_768<256>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 512) {
                three_qgemm_lut_768_768<512>(A, sign, LUT, Scales, LUT_Scales, C);
            }
        }
    }
    else if (m == 3072 && k == 768) {
        if (BK == 0) {
            if (bs == 1) {
                two_qgemm_lut_3072_768<1>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 8) {
                two_qgemm_lut_3072_768<8>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 32) {
                two_qgemm_lut_3072_768<32>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 128) {
                two_qgemm_lut_3072_768<128>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 256) {
                two_qgemm_lut_3072_768<256>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 512) {
                two_qgemm_lut_3072_768<512>(A, LUT, Scales, LUT_Scales, C);
            }
        }
        else if (BK == 768) {
            if (bs == 1) {
                three_qgemm_lut_3072_768<1>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 8) {
                three_qgemm_lut_3072_768<8>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 32) {
                three_qgemm_lut_3072_768<32>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 128) {
                three_qgemm_lut_3072_768<128>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 256) {
                three_qgemm_lut_3072_768<256>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 512) {
                three_qgemm_lut_3072_768<512>(A, sign, LUT, Scales, LUT_Scales, C);
            }
        }
    }
    else if (m == 768 && k == 3072) {
        if (BK == 0) {
            if (bs == 1) {
                two_qgemm_lut_768_3072<1>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 8) {
                two_qgemm_lut_768_3072<8>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 32) {
                two_qgemm_lut_768_3072<32>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 128) {
                two_qgemm_lut_768_3072<128>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 256) {
                two_qgemm_lut_768_3072<256>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 512) {
                two_qgemm_lut_768_3072<512>(A, LUT, Scales, LUT_Scales, C);
            }
        }
        else if (BK == 3072) {
            if (bs == 1) {
                three_qgemm_lut_768_3072<1>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 8) {
                three_qgemm_lut_768_3072<8>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 32) {
                three_qgemm_lut_768_3072<32>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 128) {
                three_qgemm_lut_768_3072<128>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 256) {
                three_qgemm_lut_768_3072<256>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 512) {
                three_qgemm_lut_768_3072<512>(A, sign, LUT, Scales, LUT_Scales, C);
            }
        }
    }
}
