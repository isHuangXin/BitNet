#!/bin/bash
# YOCO-U L3 Cache Benchmark: F16 vs I2_S (models fit entirely in CPU L3 cache)
# L3 = 48 MiB per NUMA node (Intel Xeon Platinum 8358P)
#
# Usage: cd /home/huangxin/code_list/BitNet && bash benchmark_yoco_u_L3_cache_cpu.sh [threads] [numa_node]
# Examples:
#   bash benchmark_yoco_u_L3_cache_cpu.sh 8 0    # 8 threads, NUMA 0
...
echo "========================================================"
echo "  YOCO-U L3 Cache Benchmark: F16 vs I2_S"
echo "  Both models fit in L3 cache (48 MiB per NUMA node)"
...
echo "  F16:  $F16_SIZE"
echo "  I2_S: $I2S_SIZE"
echo "  L3 Cache: 48 MiB per NUMA node"
echo

echo "--- F16 Benchmark (in L3 cache) ---"
$TASKSET $BENCH -m $F16_MODEL -t $THREADS -p 128,256,512 -n 128 -r 3 -ngl 0

echo
echo "--- I2_S Benchmark (in L3 cache) ---"
