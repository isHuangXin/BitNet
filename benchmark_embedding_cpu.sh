...
#
# Models: multilingual-e5-base (109M) and multilingual-e5-large (335M)
#
...
# e5-base (109M params, hidden=768)
...
# e5-large (335M params, hidden=1024)
...
echo "  Models: multilingual-e5-base (109M), e5-large (335M)"
...
# ============================================================
echo "========================================================"
echo "  e5-base (109M params, hidden=768, intermediate=3072)"
echo "========================================================"
...
echo
echo "========================================================"
echo "  e5-large (335M params, hidden=1024, intermediate=4096)"
echo "========================================================"
